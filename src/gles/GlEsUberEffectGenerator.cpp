...
std::string CGlEsUberEffectGenerator::GenerateVertexShader(const EFFECTCAPS& caps)
{
...
std::string CGlEsUberEffectGenerator::GeneratePixelShader(const EFFECTCAPS& caps)
{
	std::string result;
...
bool CGlEsUberEffectGenerator::HasCoordSrc(const EFFECTCAPS& caps, unsigned int texCoordSource)
{
	return
...
std::string CGlEsUberEffectGenerator::GenerateDiffuseMapCoordOutput(unsigned int index, DIFFUSE_MAP_COORD_SOURCE source)
{
	std::string result;
	switch(source)
	{
...
std::string CGlEsUberEffectGenerator::GenerateDiffuseMapCoordComputation(unsigned int index, DIFFUSE_MAP_COORD_SOURCE source)
{
	std::string result;
	switch(source)
	{
...
std::string CGlEsUberEffectGenerator::GenerateDiffuseMapSampler(unsigned int index, DIFFUSE_MAP_COORD_SOURCE source)
{
	std::string result;
	switch(source)
	{
...
std::string CGlEsUberEffectGenerator::GenerateDiffuseMapMatrixUniform(unsigned int index)
{
	std::string result;
...
std::string CGlEsUberEffectGenerator::GenerateDiffuseMapSampling(unsigned int index, DIFFUSE_MAP_COORD_SOURCE source, DIFFUSE_MAP_COMBINE_MODE combineMode)
{
	std::string result;
